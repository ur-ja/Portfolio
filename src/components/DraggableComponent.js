...
export default function DraggableComponent() {
  ...
  const [layout, setlayout] = useState([
    ...
    { i: 'i', x: 0, y: 21, w: 5, h: 9 },
    { i: 'j', x: 5, y: 21, w: 5, h: 9 },
  ]);
    ...
    >
      ...
      >
        ...
        <p className='p-4 font-poppins font-light'>
          Hi! I'm{' '}
          <span className='mx-1 text-2xl md:text-3xl font-extrabold'>urja</span>
          , a software engineering student at UNSW. I'm passionate about
          technology, and design. I enjoy building products that make a
          difference in people's lives.
        </p>
      </div>
      <div key='b' data-grid={layout[1]} className='block bg-white rounded-3xl'>
      ...
      >
        ...
        <p className=''>
          ...
          preparation, and job applications was instrumental in shaping my
          career path.
        </p>
      </div>
      <button
      ...
      <div
        key='i'
        data-grid={layout[8]}
        className='flex flex-col bg-white rounded-3xl p-7 hover:cursor-pointer'
      ...
      >
        ...
        <p className='mb-3'>
          ...
          Program, and the challenges I've faced as a woman in a male-dominated
          field.
        </p>
      </div>
    </ResponsiveReactGridLayout>
